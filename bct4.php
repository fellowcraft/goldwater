...
a1, a2  diskin2 "../WAV/water2.wav", ifreq, iskiptime, 1
...
$endT    = 60*2+13;
$TT      = 60*15;
$Events  = intval($TT*120);         // events  per second
// --------------------------- sco head ----------------------------------------
$scoreHeader =  '; Reverb
i99     0   '.($TT+$tailT).'   
...
function p2() {
Global $TT;
// return round(stats_rand_gen_funiform(1,$TT),3);
return round(stats_rand_gen_beta(5,1)*$TT,3);
}
...
$TDur = round(stats_rand_gen_funiform(0.004,0.1),3); 
...
// return round(stats_rand_gen_funiform(.2,1.8),3); 
...
Global $TDur;
Global $rndat;
$rndat = stats_rand_gen_funiform(0.001,$TDur);

return round($rndat,3);
}

function irel() {
Global $TDur;
Global $rndat;
return round($TDur-$rndat,3);
}


function ipanStart() {
return round(stats_rand_gen_funiform(0,1),3); 
//return .5;
}
